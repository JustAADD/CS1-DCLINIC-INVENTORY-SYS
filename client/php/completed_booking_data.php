...
if (isset($_GET['deleteid'])) {
  ...
  $delete_query = "DELETE FROM booking_completed WHERE id = '$delete_id'";

  if ($con->query($delete_query) === TRUE) {


    header("Location: ../php/completed_booking.php");
  } else {
  }
...
<body>
  ...
  <div class="body">
    <table class="table table-bordered">
      ...
      <!-- data -->
      <?php
      $selectquery = "SELECT * FROM booking_completed ORDER BY ID DESC";
        ...
        echo '
          <tbody>
                  <tr class="centered-row">
                    ...
                    <td><a href="../php/completed_booking_data.php? deleteid=' . $id . '"><button class="btn btn-dark btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa-solid fa-trash"  style="color:red;"></i></button></a> 
